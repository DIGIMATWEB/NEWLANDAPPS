...
public class GeneralConstantsV2 {
    ...
    public static final String TELEPHONE_PREFERENCE="TELEPHONE_PREFERENCES";
    ...
    public static final String LEVEL_PERMISIONS = "PROFILEPERMISSIONS";

    public static final String DIRECCION_USER = "Direccion de entrega";   /**aqui haria falta la latitu y longitud de entrega*/

    public static final String URL_SPLASH_IMAGE="image";
    public static final String RGBA_COLOR="#ff";
    public static final String APP_NAME="zpidi";

    public static final String JSON_MENU = "JSON_MENU";

    public static final String DATA_LOCALES = "CLOSE_SESSION_PREFERENCES";
    ...
    //settings
    public static final String LOOP_IN_PROGRES ="0";
